...
import nc.bs.hrss.ta.common.cmd.TaApplyLineAddCmd;
import nc.bs.hrss.ta.common.cmd.TaApplyLineInsertCmd;
...
public abstract class TaApplyBaseView extends BaseController {
	...
	public void onLineAdd(MouseEvent<MenuItem> mouseEvent) {
		CmdInvoker.invoke(new TaApplyLineAddCmd(getDetailDsId(), null));
	}
	...
	public void onLineInsert(MouseEvent<MenuItem> mouseEvent) {
		CmdInvoker.invoke(new TaApplyLineInsertCmd(getDetailDsId(), null));
	}
	 ...
	 * @param mouseEvent
	 */
	public void onAttachmentUpload(MouseEvent<MenuItem> mouseEvent) {
